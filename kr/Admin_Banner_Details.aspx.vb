    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        Try
            ...
            If Len(strHeight) > 0 Or Len(strWidth) > 0 Then
                strBanner_HTMLCode = "<a href=http://sbobetpoker.com/kr/?lang=kr><img src=http://affiliate.sbobetpoker.com/kr/Images/Banner/" + strBanner_Image + " height=" + strHeight + " width=" + strWidth + "/></a>"
            Else
            ...
            Else
                ...
                sqlcommand.Parameters.Add(New SqlParameter("@CountryRECID", SqlDbType.UniqueIdentifier)).Value = Session("CountryRECID")
            End If
