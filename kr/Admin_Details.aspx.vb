...
Partial Class Admin_Details
    ...
    Private Sub LoadContent(Optional ByVal strLoginRECID As String = "")
        ...
        Try
            ...
            If IsDBNull(sqlcommand.Parameters("@Register_Url").Value) = False Then
                txtRegisterUrl.Text = sqlcommand.Parameters("@Register_Url").Value.ToString
            End If

            If IsDBNull(sqlcommand.Parameters("@Game_Url").Value) = False Then
                txtGameUrl.Text = sqlcommand.Parameters("@Game_Url").Value.ToString
            End If
...
SkipChecking:
        ...
        Try
            ...
            If Len(txtRegisterUrl.Text) > 0 Then
                strRegisterURL = txtRegisterUrl.Text
            End If

            If Len(txtGameUrl.Text) > 0 Then
                strGameURL = txtGameUrl.Text
            End If
            ...
            sqlcommand.Parameters.Add(New SqlParameter("@Register_Url", SqlDbType.VarChar, 50)).Value = strRegisterURL
            sqlcommand.Parameters.Add(New SqlParameter("@Game_Url", SqlDbType.VarChar, 50)).Value = strGameURL
