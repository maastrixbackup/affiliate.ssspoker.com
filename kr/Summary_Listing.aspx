<%@ Page Title="" Language="VB" MasterPageFile="~/kr/MasterPage2.master" AutoEventWireup="false" CodeFile="Summary_Listing.aspx.vb" Inherits="Summary_Listing" %>
    ...
    <form id="form2" class="form" runat="server">
                ...
                <div class="widget">
                    <div class="title">
                        ...
                        <div class="formSubmit">
                           ...
                           <%-- <asp:LinkButton ID="LinkButton1" runat="server" CssClass="blueB ml10" CausesValidation="false">찾기</asp:LinkButton>--%>
        ...
        <div id="gvTable" runat="server" class="wrapper">
            <div id="table" class="widget">
                <asp:GridView ID="Grid1" CssClass="display dTable" runat="server"  AllowPaging="true" PageSize="50" OnPageIndexChanging = "OnPaging" AutoGenerateColumns="false" AllowSorting="true" OnSorting="Grid1_Sorting">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="아이디" DataField="Username" SortExpression="Username" />
                        <asp:BoundField HeaderText="제휴 코드" DataField="AffliateCode" SortExpression="AffliateCode" />
                        <asp:BoundField HeaderText="턴오버" DataField="Real_Turnover" SortExpression="Real_Turnover" />
                        <asp:BoundField HeaderText="커미션" DataField="Comm" SortExpression="Comm" />
                    </Columns>
                </asp:GridView>
