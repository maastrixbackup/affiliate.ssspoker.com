<%@ Page Title="" Language="VB" MasterPageFile="~/kr/MasterPage2.master" AutoEventWireup="false" CodeFile="Banner_Listing.aspx.vb" Inherits="Banner_Listing" ValidateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="row row-padding container-fluid">
        ...
        <div class="col-md-9">
            <div class="col-md-2"><asp:LinkButton ID="lnkSearch" runat="server" CssClass="btn btn-info" CausesValidation="false">찾기</asp:LinkButton></div>
        </div>
    </div>
