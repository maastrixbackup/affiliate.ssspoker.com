<%@ Page Language="VB" AutoEventWireup="false" CodeFile="registration-test.aspx.vb" Inherits="registrationMobile2" %>
    ...
    -->
        <div id="content" class="page-content" data-snap-ignore="true">
                        ...
                        <form runat="server" method="post" id="form_reg" style="margin-top: 14px;">
                            ...
                            <div class="pg_1">
                                <div class="col-xs-12 p-0">
                                    ...
                                    <div class="col-xs-10 p-0">
                                        <asp:TextBox runat="server" ID="user_name" MaxLength="10" CssClass="no-br form-control" onfocus="this.value=''" onblur="fast_checking('user_name', 'ceklis1', 'user_nameid')" onkeyup="this.value=this.value.replace(/[^a-zA-Z0-9_]/g,'');" onkeypress="this.value=this.value.replace(/[^a-zA-Z0-9_]/g,'');" data-required="true" placeholder="아이디*"></asp:TextBox>
                                        <br>
                                        <asp:RequiredFieldValidator ID="rfvUsername" runat="server" ControlToValidate="user_name" ErrorMessage="Username is required." ForeColor="Red"></asp:RequiredFieldValidator>
                                <asp:RegularExpressionValidator ID="revUsername" runat="server" ControlToValidate="user_name" ValidationExpression="^[a-zA-Z0-9_]{5,255}$" ErrorMessage="Please input without whitespace." ForeColor="Red"></asp:RegularExpressionValidator>
                                    </div>
                                ...
                                <div class="col-xs-12 p-0">
                                    ...
                                    <div class="col-xs-10 p-0">
                                        <asp:TextBox runat="server" ID="user_nameid" MaxLength="10" CssClass="no-br form-control" onfocus="this.value=''" onblur="fast_checking('user_nameid', 'ceklis2', 'user_name')" onkeyup="this.value=this.value.replace(/[^a-zA-Z0-9_]/g,'');" onkeypress="this.value=this.value.replace(/[^a-zA-Z0-9_]/g,'');" data-required="true" placeholder="별명은 알파벳과 숫자로 구성되어야 하며 아이디와 다르게 입력해 주세요.*"></asp:TextBox>
                                        <br>
                                        <asp:RequiredFieldValidator ID="rfvNickname" runat="server" ControlToValidate="user_nameid" ErrorMessage="Nickname is required." ForeColor="Red"></asp:RequiredFieldValidator>
                                    </div>
                                    <div class="col-xs-2 p-0">
                                ...
                                <div class="col-xs-12 p-0">
                                    ...
                                    <div class="col-xs-10 p-0">
                                        <asp:TextBox runat="server" ID="the_pass" CssClass="no-br form-control" TextMode="Password" onfocus="this.value=''" onblur="fast_checking('the_pass', 'ceklis3', '')" data-required="true" placeholder="알파벳, 숫자, @ 와 혼합하여 10자리로 입력해 주세요. 예) asdf12345@"></asp:TextBox>
                                        <br>
                                        <asp:RequiredFieldValidator ID="rfvPassword" runat="server" ControlToValidate="the_pass" ErrorMessage="Password is required." ForeColor="Red"></asp:RequiredFieldValidator>
                                        <asp:RegularExpressionValidator ID="revPassword" runat="server" ControlToValidate="the_pass" ValidationExpression="^(?=.*[A-Za-z])(?=.*\d)[A-Za-z@\d]{6,}$" ErrorMessage="Password must be alphanumeric and no symbol allowed." ForeColor="Red"></asp:RegularExpressionValidator>
                                    </div>
                                    <div class="col-xs-2 p-0">
                                ...
                                <div class="col-xs-12 p-0">
                                    ...
                                    <div class="col-xs-10 p-0">
                                        <asp:TextBox runat="server" ID="the_cpass" CssClass="no-br form-control" TextMode="Password" onfocus="this.value=''" onblur="fast_checking('the_cpass', 'ceklis4', 'the_pass')" data-required="true" placeholder="비밀 번호 확인*"></asp:TextBox>
                                        <br>
                                        <asp:RequiredFieldValidator ID="rfvConfirmPassword" runat="server" ControlToValidate="the_cpass" ErrorMessage="Confirm Password is required." ForeColor="Red"></asp:RequiredFieldValidator>
                                        <asp:CompareValidator runat="server" ID="cvPassword" ControlToCompare="the_pass" ControlToValidate="the_cpass" ErrorMessage="Password NOT match." ForeColor="Red"></asp:CompareValidator>
                                    </div>
                                    <div class="col-xs-2 p-0">
                            ...
                            <div class="pg_2" style="display: none;">
                                ...
                                <div class="col-xs-12 p-0">
                                    ...
                                    <div class="col-xs-10 p-0">
                                        <asp:TextBox runat="server" ID="the_bano" CssClass="no-br form-control" MaxLength="16" onkeypress='return event.charCode >= 48 && event.charCode <= 57' onfocus="this.value=''" onblur="fast_checking('the_bano', 'ceklis9', '')" data-required="true"></asp:TextBox>
                                    </div>
                                    <div class="col-xs-2 p-0">
                                ...
                                <div class="col-xs-12 p-0">
                                    ...
                                    <div class="col-xs-10 p-0">
                                        <asp:TextBox runat="server" ID="the_baname" CssClass="no-br form-control" onkeypress='return (event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || event.charCode = 32' onfocus="this.value=''" onblur="fast_checking('the_baname', 'ceklis8', '')" data-required="true"></asp:TextBox>
                                        <br>
                                    </div>
                                    <div class="col-xs-2 p-0">
                                ...
                                <div class="col-xs-12 p-0">
                                    ...
                                    <div class="col-xs-10 p-0">
                                        <asp:TextBox runat="server" ID="the_email" CssClass="no-br form-control" TextMode="Email" onfocus="this.value=''" onblur="fast_checking('the_email', 'ceklis6', '')" data-required="true" placeholder="이메일*"></asp:TextBox>
                                        <br>
                                        <asp:RequiredFieldValidator ID="rfvEmail" runat="server" ControlToValidate="the_email" ErrorMessage="Email Address is required." ForeColor="Red"></asp:RequiredFieldValidator>
                                    </div>
                                    <div class="col-xs-2 p-0">
                                ...
                                <div class="col-xs-12 p-0">
                                    ...
                                    <asp:TextBox runat="server" ID="the_phone" CssClass="no-br form-control" style="float: left; width: 80%;" onkeypress='return event.charCode >= 48 && event.charCode <= 57' onfocus="this.value=''" onblur="fast_checking('the_phone', 'ceklis7', '')" data-required="true"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="rfvContactNo" runat="server" ControlToValidate="the_phone" ErrorMessage="Contact No. is required." ForeColor="Red"></asp:RequiredFieldValidator>
                                    </div>
                                    <div class="col-xs-2 p-0">
            ...
            <script>
                ...
                $(document).ready(function () {
                    validate();
                    $('#txtUsername, #checkbox').change(validate);
                });
                ...
                function fast_checking(id_div, id_div2, id_div3) {
                    ...
                    var data = { column: id_div, value1: id_val, value2: id_val2 }
                    var params = JSON.stringify(data);
                    $.ajax({
                        type: "POST",
                        url: "../fast_checking.aspx/RegisterValidation",
                        async: true,
                        data: params,
                        ...
                        success: function (result) {
                            if (result.d.status == "0") {
                                ...
                                $('#' + id_div2).html("<img src='../resources/images/close.svg' width='25' title='" + result.d.message + "' />");
                                $('#' + id_div).val(result.d.status);
                            } else {
                                ...
                                $('#' + id_div2).html("<img src='../resources/images/check.svg' width='25' style='margin-top: 4px;' title='" + result.d.message + "' />");
                    ...
                    /*$.post("../fast_checking.aspx/RegisterValidation", { column: id_div, value1: id_val, value2: id_val2 },
                        function (result) {
                            ...
                            if (inresult[0] == "0") {
                                ...
                                if (id_div == "txtPassword" || id_div == "txtConfirmPassword") {
                                    $('#' + id_div).get(0).type = 'text';
                                    $('#' + id_div).keyup(function () {
                                        $('#' + id_div).get(0).type = 'password';
                                    });
