<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="Admin_Summary_Listing.aspx.vb" Inherits="Admin_Summary_Listing" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:HiddenField ID="hldGrid1" runat="server" />
            <div class="row row-padding container-fluid">
